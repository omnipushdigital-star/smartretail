...
async function check() {
    console.log("--- Checking Bundle e1c05f1a-7961-4fee-bae5-33349d35416c ---");
    const { data: files } = await supabase.from('bundle_files')
        .select('*, media:media_assets(*)')
        .eq('bundle_id', 'e1c05f1a-7961-4fee-bae5-33349d35416c');

    console.log("Files count in bundle:", files?.length);
